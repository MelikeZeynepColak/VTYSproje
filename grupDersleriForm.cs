...
namespace VTYSproje
{
    public partial class grupDersleriForm : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                if (!string.IsNullOrEmpty(idtxt.Text) && !string.IsNullOrEmpty(tarihtext.Text) && !string.IsNullOrEmpty(saattext.Text) && !string.IsNullOrEmpty(egitmenid.Text) && !string.IsNullOrEmpty(dersaditxt.Text))
                {
